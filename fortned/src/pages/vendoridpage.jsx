          ...
          <div className="max-w-4xl mx-auto">
            <Card>
              <div className="p-6 text-center">
                ...
                <p className="mb-6">{error || "The vendor you're looking for doesn't exist or has been removed."}</p>
          ...
          <Card className="mb-8">
            <div className="p-6">
              ...
              <div className="mb-4 bg-blue-50 p-4 rounded-lg">
                <h2 className="font-semibold text-lg mb-1">About {vendor.name}</h2>
          ...
          <Card className="mb-8">
            <div className="p-6">
              ...
              {vendor.services && vendor.services.length > 0 ? (
                ...
                <p className="text-gray-600">No services listed for this vendor.</p>
              )}
            </div>
          </Card>
