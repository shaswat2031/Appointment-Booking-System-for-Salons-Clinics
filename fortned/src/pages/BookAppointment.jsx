...
const BookAppointment = () => {
  ...
  const validateForm = () => {
    ...
    Object.entries(formData).forEach(([name, value]) => {
      if (
        ...
        if (!value) {
          errors[name] = `${
            name === "vendorId" ? "Professional" : name
          } is required`;
          isValid = false;
        } else {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage(
        res.data.message || "Your appointment has been successfully booked!"
      );
      ...
      setError(
        err.response?.data?.message ||
          "Unable to book your appointment. Please check your details and try again."
      );
    } finally {
      setLoading(false);
    }
  ...
  const selectedVendor = vendors.find(
    (vendor) => vendor._id === formData.vendorId
  );
  const vendorCategory = selectedVendor?.category?.toLowerCase() || "";
  const availableServices = vendorCategory.includes("salon")
    ? serviceCategories.salon
    : vendorCategory.includes("clinic")
    ? serviceCategories.clinic
    ...
    <>
      ...
      <div className="max-w-4xl mx-auto p-8 my-8 bg-white rounded-lg shadow-lg">
        ...
        <p className="text-center text-gray-600 mb-8">
          Schedule your visit with our top professionals in just a few clicks
        </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <input
                    ...
                    className={`w-full border ${
                      formErrors.customerName
                        ? "border-red-300"
                        : "border-gray-300"
                    } p-3 pl-10 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition`}
                  />
                </div>
                {formErrors.customerName && (
              ...
              <div>
                ...
                <select
                  ...
                  required
                  className={`w-full border ${
                    formErrors.vendorId ? "border-red-300" : "border-gray-300"
                  } p-3 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition`}
                >
              ...
              <button
                ...
                className={`w-full bg-blue-600 ${
                  loading || hasErrors()
                    ...
                    : "hover:bg-blue-700"
                } text-white font-medium py-3 px-4 rounded-md transition duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 flex items-center justify-center`}
              >
                {loading ? (
                  <>
                    <svg
