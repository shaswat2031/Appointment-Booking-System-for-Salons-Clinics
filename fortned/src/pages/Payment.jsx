...
const Payment = () => {
  ...
  const handlePayment = (e) => {
    ...
    setTimeout(() => {
      ...
      const paymentToken = `pay_${Date.now()}_${Math.random()
        .toString(36)
        .substr(2, 9)}`;
          ...
          <Card>
            <div className="p-6">
                ...
                <div className="border-t border-gray-200 pt-6 mt-6">
                  ...
                  <div className="bg-yellow-50 border border-yellow-100 rounded-lg p-4 mb-6">
                    <p className="text-sm text-yellow-700">
                      <strong>Demo Mode:</strong> No actual payment will be
                      processed. Click "Complete Payment" to simulate.
                    </p>
                  </div>
              ...
              <p className="text-xs text-gray-500 mt-6">
                ...
                and privacy policy. After payment, you'll be redirected to
