...
const VendorRegister = () => {
  ...
  const handleServiceChange = (index, field, value) => {
    ...
    if (
      ...
      formErrors.services[index][field]
    ) {
            ...
            <Card>
              <div className="text-center p-6">
                ...
                <p className="text-gray-600 mb-6">
                  You need to purchase a subscription plan before registering as
                  a vendor.
                </p>
                <div className="flex flex-col space-y-3">
                  <Button to="/#pricing" fullWidth>
                    View Pricing Plans
                  </Button>
                  <Button to="/vendor/login" variant="outline" fullWidth>
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          {" "}
          {/* Increased width to accommodate service table */}
          <Card>
            <div className="text-center mb-6">
              ...
              <p className="mt-2 text-gray-600">
                Your payment was successful! Complete your registration below.
              </p>
            </div>
